...
function App() {
  ...
  return (
    ...
    >
        ...
        >
                ...
                {userInfo ? (
                  ...
                  >
                    ...
                    <LinkContainer to="/orderhistory">
                      <NavDropdown.Item>Historico de pedidos</NavDropdown.Item>
                    </LinkContainer>
                    <NavDropdown.Divider />
                    <Link
                  ...
                  <NavDropdown className="header-link" title={`Olá, sign in`}>
          ...
          <div className="tags">
            <div className="d-flex">
              ...
              >
                <i className="fas fa-bars"></i> Todos
              </Link>
              {['Promoção', 'Mais vendidos hoje'].map((x) => (
                <Link
                  key={x}
      ...
      >
        <ListGroup variant="flush">
          <ListGroup.Item action className="side-navbar-user">
            ...
            >
              <span>
                {userInfo ? `Olá, ${userInfo.name}` : `Olá, sign in`}
              </span>
            </LinkContainer>
          </ListGroup.Item>
          <ListGroup.Item>
      ...
      <footer>
        <div className="text-center">WebStore - 2023</div>
      </footer>
    </div>
  )
}
